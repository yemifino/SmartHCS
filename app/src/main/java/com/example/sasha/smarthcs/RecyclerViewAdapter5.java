...
public class RecyclerViewAdapter5 extends RecyclerView.Adapter<RecyclerViewAdapter5.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.costt.setText(Integer.toString(MainActivity.cards2.get(i).now.sum_w + MainActivity.cards2.get(i).now.sum_g + MainActivity.cards2.get(i).now.sum_l) + " Рублей");
    }
